...
namespace Basic.Cookies.Controllers
{
    public class OperationsController : Controller
    {
        ...
        {
            var result = await _authorizationService.AuthorizeAsync(User, null,new OperationAuthorizationRequirement { Name = CookieJarOperations.Open});
    ...
    public class CookieJarHandler : AuthorizationHandler<OperationAuthorizationRequirement>
    {
